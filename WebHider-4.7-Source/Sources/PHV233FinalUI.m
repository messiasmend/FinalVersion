...
static void P233Render(id self, SEL _cmd, BOOL hierarchyMode) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        UIButton*copy=[UIButton buttonWithType:UIButtonTypeSystem];copy.translatesAutoresizingMaskIntoConstraints=NO;copy.backgroundColor=UIColor.clearColor;[copy addTarget:vc action:@selector(copyTapped) forControlEvents:UIControlEventTouchUpInside];[copy addTarget:vc action:@selector(phv44_hapticButtonTapped:) forControlEvents:UIControlEventTouchUpInside];[copyC addSubview:copy];
        ...
        UIButton*hidden=[UIButton buttonWithType:UIButtonTypeSystem];hidden.translatesAutoresizingMaskIntoConstraints=NO;hidden.backgroundColor=UIColor.clearColor;[hidden addTarget:vc action:@selector(hiddenTapped) forControlEvents:UIControlEventTouchUpInside];[hidden addTarget:vc action:@selector(phv44_hapticButtonTapped:) forControlEvents:UIControlEventTouchUpInside];[hiddenC addSubview:hidden];
        ...
        UIButton*hide=[UIButton buttonWithType:UIButtonTypeSystem];hide.translatesAutoresizingMaskIntoConstraints=NO;hide.backgroundColor=UIColor.clearColor;[hide addTarget:vc action:@selector(hideTapped) forControlEvents:UIControlEventTouchUpInside];[hide addTarget:vc action:@selector(phv44_hapticButtonTapped:) forControlEvents:UIControlEventTouchUpInside];[hideC addSubview:hide];
        ...
        [NSLayoutConstraint activateConstraints:@[
            [panel.centerXAnchor constraintEqualToAnchor:vc.view.centerXAnchor],[panel.centerYAnchor constraintEqualToAnchor:vc.view.centerYAnchor],[panel.widthAnchor constraintEqualToConstant:350],[panel.heightAnchor constraintEqualToConstant:516],
            ...
            [copyC.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[copyC.topAnchor constraintEqualToAnchor:seg.bottomAnchor constant:12],[copyC.heightAnchor constraintEqualToConstant:80],[copyC.widthAnchor constraintEqualToConstant:102],
