...
static void P233Render(id self, SEL _cmd, BOOL hierarchyMode) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [NSLayoutConstraint activateConstraints:@[
            [panel.centerXAnchor constraintEqualToAnchor:vc.view.centerXAnchor],[panel.centerYAnchor constraintEqualToAnchor:vc.view.centerYAnchor],[panel.widthAnchor constraintEqualToConstant:350],[panel.heightAnchor constraintEqualToConstant:548.4],
            ...
            [copyC.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[copyC.topAnchor constraintEqualToAnchor:seg.bottomAnchor constant:25],[copyC.heightAnchor constraintEqualToConstant:86.4],[copyC.widthAnchor constraintEqualToConstant:102],
            ...
            [copyIcon.centerXAnchor constraintEqualToAnchor:copyC.centerXAnchor],[copyIcon.topAnchor constraintEqualToAnchor:copyC.topAnchor constant:10],[copyIcon.widthAnchor constraintEqualToConstant:30],[copyIcon.heightAnchor constraintEqualToConstant:30],
            ...
            [hiddenIcon.centerXAnchor constraintEqualToAnchor:hiddenC.centerXAnchor],[hiddenIcon.topAnchor constraintEqualToAnchor:hiddenC.topAnchor constant:10],[hiddenIcon.widthAnchor constraintEqualToConstant:30],[hiddenIcon.heightAnchor constraintEqualToConstant:30],
            ...
            [hideIcon.centerXAnchor constraintEqualToAnchor:hideC.centerXAnchor],[hideIcon.topAnchor constraintEqualToAnchor:hideC.topAnchor constant:10],[hideIcon.widthAnchor constraintEqualToConstant:30],[hideIcon.heightAnchor constraintEqualToConstant:30],
            ...
            [close.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[close.topAnchor constraintEqualToAnchor:copyC.bottomAnchor constant:25],[close.heightAnchor constraintEqualToConstant:42],[close.trailingAnchor constraintEqualToAnchor:panel.centerXAnchor constant:-5],
            [save.leadingAnchor constraintEqualToAnchor:panel.centerXAnchor constant:5],[save.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[save.topAnchor constraintEqualToAnchor:copyC.bottomAnchor constant:25],[save.heightAnchor constraintEqualToConstant:42]
        ]];
    });
}
